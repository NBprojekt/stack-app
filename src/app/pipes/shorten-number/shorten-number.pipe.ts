...
export class ShortenNumberPipe implements PipeTransform {
  ...
  transform(value: number): string {
    ...
    switch (x.length) {
      ...
      case 5: return `${x.slice(0, 1)}.${x[2]}k`;
      case 6: return `${x.slice(0, 2)}k`;
      case 7: return `${x[0]}.${x[1]}m`;
      case 8: return `${x.slice(0, 1)}.${x[2]}m`;
      case 9: return `${x.slice(0, 2)}m`;
      case 10: return `${x[0]}.${x[1]}m`;
      case 11: return `${x.slice(0, 1)}.${x[2]}m`;
      case 12: return `${x.slice(0, 2)}m`;
